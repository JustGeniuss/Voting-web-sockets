...
const WaitingRoom: React.FC = () => {
    ...
    const [participantToRemove, setIsParticipantToRemove] = useState<string>();
    const [showConfirmation, setShowConfirmation] = useState(false);


    const currentState = useSnapshot(state);

    const confirmRemoveParticipants = (id: string) => {
        setIsConfirmationMessage(
            `Remove ${currentState.poll?.participants[id]} from poll`
        )
        setIsParticipantToRemove(id);
    ...
    return (
        <>
            ...
            <div className="flex flex-col w-full justify-between items-center h-full">
                <div>
                    ...
                    <div
                        ...
                        <div
                            className='font-extrabold text-center mr-2'>
            ...
            <ParticipantList
                ...
                onRemoveParticipant={confirmRemoveParticipants}
            ...
            <NominationForm
                ...
                userID={currentState.me?.id}
                onRemoveNomination={(nominationdID) =>
                    actions.removeNomination(nominationdID)}
                isAdmin={currentState.isAdmin || false}
            />
            <ConfirmationDialog
